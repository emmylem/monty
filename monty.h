...
/**
 * struct meta_s - contents of line and corresponding number
 * @buf: buffer
 * @stack: LIFO
 * @file: file
 * Description: contents of a line and corresponding number
...
/* Parse/ tokeniser functions */
void parsefile(FILE *file);
void parseline(line_t *line, char *buffer);

/* Verification functions to check arg*/
bool comment_check(line_t line);
void push_check(line_t line, meta_t *meta, char *opcode);

/* Stack manipulation functions on line number*/
